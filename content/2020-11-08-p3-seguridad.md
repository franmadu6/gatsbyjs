...
1. Tu clave pública debe estar en un servidor de claves
2. Escribe tu fingerprint en un papel y dárselo a tu compañero, para que puede descargarse tu clave pública.
3. Te debes bajar al menos tres claves públicas de compañeros. Firma estas claves.
4. Tu te debes asegurar que tu clave pública es firmada por al menos tres compañeros de la clase.
5. Una vez que firmes una clave se la tendrás que devolver a su dueño, para que otra persona se la firme.
6. Cuando tengas las tres firmas sube la clave al servidor de claves y rellena tus datos en la tabla Claves públicas PGP 2020-2021
7. Asegurate que te vuelves a bajar las claves públicas de tus compañeros que tengan las tres firmas.
